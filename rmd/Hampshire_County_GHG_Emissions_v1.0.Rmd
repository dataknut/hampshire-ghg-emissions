...
data.table::fwrite(h_beis_sum_allYears_DT, here::here("data", "all_hampshire_beis_categories_sum_kTCO2_allYears.csv"))
```
...
data.table::fwrite(districts,
                   here::here("data", "all_hampshire_districts_sum_ktCO2(e)_v1_methods.csv"))
